...
queue_dir=f"{script_dir}/queue"
queue_file=f"{script_dir}/queue.txt"
recently_played_history_file=f"{script_dir}/recently_played_history.txt"
    ...
    while True:
        ...
        if selected_command == "queue" and video_url:
            Thread(
                ...
                args=(video_url.group(4), username,),
                daemon=True,
            ).start()
